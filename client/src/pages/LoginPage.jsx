    ...
    gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      flex-col gap-6 rounded-lg shadow-lg'>
        ...
        {currState === "Sign Up" && isDataSubmitted && (
          ...
          rows={4} className='p-2border border-gray-500 rounded-md focus:outline-none
          focus:ring-2 focus:ring-indigo-500p' placeholder='provide a short bio...' required></textarea>
         )
        }
